import type { CallGraphDt, CallGraphNodeDt, GlobalID, IRObjPath } from "remusys-wasm-b2";
...
function makeNodes(callGraph: CallGraphDt, focusPath: IRObjPath): FlowElemNode[] {
...
export function getCallGraph(irState: IRState): FlowGraph {
	const callGraph = irState.getCallGraph();
